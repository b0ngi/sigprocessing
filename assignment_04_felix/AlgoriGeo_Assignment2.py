...
def cube(input_faces, input_points):
  ...
  for point in vertices:
    for edge_point in edge_points:
      ...
      if(tuple(point) in edge_points[edge_point]):
        ...
        vertices[tuple(point)].append(edge_point)   
  ...
  for vertex in vertices:
    ...
    avg_face_points = (face_points[vertices[vertex][0]] + 
                       face_points[vertices[vertex][1]] + 
                       face_points[vertices[vertex][2]])/3
    ...
    new_input_points_dict[tuple(new_vertex)] = [[list(face_points[vertices[vertex][0]]),
                                                list(face_points[vertices[vertex][1]]),
                                                list(face_points[vertices[vertex][2]])]]
